...
public class Config {
    ...
    public Config(final ForgeConfigSpec.Builder builder) {
        ...
        this.amountOfLives = buildInt(builder, "Amount of Lives:",  -1, -1, Integer.MAX_VALUE,  "This introduces a new lives system where when a player loses all their max hearts, they will lose a life and their max hearts will reset. When they lose all their lives, they permanently die. You can gain a life if your max hearts are double your starting hearts. Setting this to -1 will disable this feature.");
        ...
        this.maximumamountofheartsgainable = buildInt(builder, "Maximum Amount of Health/Hitpoints a Player can get:",  -1, -1, Integer.MAX_VALUE, "WARNING: THIS IS INCOMPATIBLE WITH LIVES. IF YOU ENABLE BOTH, LIVES WILL AUTOMATICALLY BE DISABLED. This values makes a limit SET after your Starting Heart Difference for how many hit points a player can get. 2 hit points = 1 heart. Set this to less than 1 to disable the feature.");
    }
