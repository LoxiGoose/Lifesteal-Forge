...
import net.goose.lifesteal.CapabilityRegistry;
...
public class HeartCapAttacher {
    private static class HeartCapProvider implements ICapabilityProvider, INBTSerializable<CompoundTag> {

        public static final ResourceLocation IDENTIFIER = new ResourceLocation("lifesteal", "healthdifference");

        private final IHeartCap backend = new HeartCap(null);
